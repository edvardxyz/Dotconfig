...
zstyle :compinstall filename '/home/gentoo/.zshrc'
...
alias vim='devour emacsclient --socket-name=/tmp/emacs1000/server -c -a emacs'
alias emacs='devour emacsclient --socket-name=/tmp/emacs1000/server -c -a emacs'
alias e='devour emacsclient --socket-name=/tmp/emacs1000/server -c -a emacs'
